...
parser.add_argument('--pretrained', type=Path, metavar='FILE',
                    default="/mnt/lustre/zhangshaofeng/workspace/whitening_224/checkpoint/resnet18-fea-hidden-256-batch-1024.pth",
...
parser.add_argument('--checkpoint-dir', default='/mnt/lustre/zhangshaofeng/workspace/whitening_224/checkpoint_eval/', type=Path,
...
def main_worker(gpu, args):
    ...
    if (args.checkpoint_dir / 'checkpoint_eval---.pth').is_file():
        ckpt = torch.load(args.checkpoint_dir / 'checkpoint_eval.pth',
                          map_location='cpu')
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        if args.rank == 0:
            ...
            torch.save(state, args.checkpoint_dir / 'checkpoint_eval.pth')
